...
<body>
    ...
    <div id="main" style="margin-left: 150px">
        ...
        <br><p id="login">Se deseja se cadastrar em nosso website <a href="cadastro.html">clique aqui</a> .</p><br>
        ...
        <br><br><b style="margin-left: 262px">CPF: <input style="margin-left: 20px" type="text" name="cpf" maxlength="50" size="45" class="cform"></b>
        <br><br><b style="margin-left: 250px">Senha: <input style="margin-left: 20px" type="text" name="senha" maxlength="50" size="45" class="cform"></b>

        <br><br><br><button style="margin-left: 320px; width: 80px; height: 25px;">Conectar-se</button>
        <button style="margin-left: 20px; width: 140px; height: 25px;">Esqueceu sua senha?</button>
