...
<body>
    ...
    <div id="main" style="margin-left: 150px">
        ...
        <br><p id="login">Dúvidas Frequentes.</p>
            ...
            <div class="row"> 
                <div class="col-sm-6 col-md-4"> 
                    <div class="thumbnail"> 
                        ...
                        <div class="caption" style="height: 250px"> 
                            ...
                            <p id="textbox-text"><a href="sobre.php" class="btn btn-primary" role="button" style="text-decoration: none">Descrição Completa</a> 
                        </div> 
                    </div> 
                </div> 
                ...
                <div class="col-sm-6 col-md-4"> 
                    <div class="thumbnail"> 
                        ...
                        <div class="caption" style="height: 250px" style="margin-left: 20px">
                            <h3>Contato</h3>
